...
Δύο παιγνίδια και έναν όμορφο αναλογικό γραφικό περιβάλλον που επιδεικνύει πχ θερμοκρασία και υγρασία
...
Με την κίνηση του χεριού μας λαμβάνει μέσω hc-sr04 το uno τα δεδομένα ,τα οποία θα μεταφέρονται στο pc 
